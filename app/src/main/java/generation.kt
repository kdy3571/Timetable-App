...
//) {
//
//    val em_list: ArrayList<ViewModel.Subject> = model.requestList("4", "1", "전공선택")
//    val ge_list: ArrayList<ViewModel.Subject> = model.requestList("4", "1", "교양선택")
//    val cs_list: ArrayList<ViewModel.Subject> = model.requestList("4", "1", "필수")
//
